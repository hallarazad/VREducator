...
public class GvrReticle : MonoBehaviour, IGvrGazePointer {
  ...
  public void OnGazeStart(Camera camera, GameObject targetObject, Vector3 intersectionPosition,
                          bool isInteractive) {
		if (targetObject.tag == "unclickable") {
			isInteractive = false;
		}
  ...
  public void OnGazeStay(Camera camera, GameObject targetObject, Vector3 intersectionPosition,
		...
		if (Input.GetButton ("Fire1") || Input.GetButton ("Fire2") || Input.GetButton ("Fire3") || Input.GetButton ("Cancel") || Input.GetButton ("Submit")) {

			//Debug.Log ("Target Obj: " + targetObject.name);

			if (targetObject.name == "Text" || targetObject.name == "Label" || targetObject.name == "Background" || targetObject.tag == "Button") {
